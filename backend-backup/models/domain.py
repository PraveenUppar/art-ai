...
class ClassificationResult(BaseModel):
    ...
    def __str__(self):
        return f"ClassificationResult(is_relevant={self.is_relevant}, user_prompt_domain={self.user_prompt_domain}, content_domain={self.content_domain}, domain_match={self.domain_match}, alternate_domain={self.alternate_domain}, relevance_explanation={self.relevance_explanation}, confidence_score={self.confidence_score})"
